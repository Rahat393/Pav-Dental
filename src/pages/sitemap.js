...
export function Head() {
  return (
    <DynamicSeo
      title="Navigate Pav Dental Practice with Our Sitemap"
      description="Explore the layout of Pav Dental Practice through our sitemap. Easily find information about our services, treatments, and more. Streamline your visit with our organized website structure."
    />
  );
}
