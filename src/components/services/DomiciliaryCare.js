          ...
          <article className="w-full">
            <section>
              ...
              <p className="text-gray-600  text-base leading-8 text-justify mx-auto my-3">
                Pav Dental Mobile is a unique dental service that enables our
            ...
            <section>
              ...
              <p className="text-gray-600  text-base leading-8 text-justify mx-auto my-3">
                Pav Dental Mobile visits patients across the UK.
              </p>
            </section>
...
export const Head = () => (
  <DynamicSeo
    title="Mobile Dentistry Services in Leeds | Pav Dental UK"
    description=" Get the convenient mobile dental services in Leeds with Pav Dental. Our mobile dentists bring quality care to you. Schedule your appointment online now!"
  />
);
